      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="sm:col-span-2">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <a href={companyInfo.telegram} target="_blank" rel="noopener noreferrer" className="text-gray-300 hover:text-pink-400 transition-colors">
                  @complexprint_mos
                </a>
              </div>
            </div>
          ...
          <div>
            ...
            <nav className="space-y-2">
              ...
              {/* Группа "О нас" */}
              <div className="pt-2">
                <div className="text-sm font-medium text-gray-400 mb-1">О нас</div>
                <button onClick={() => go('/about-us')} className="block text-gray-300 hover:text-pink-400 transition-colors duration-200 text-left pl-3">О нас</button>
                <button onClick={() => go('/reviews')} className="block text-gray-300 hover:text-pink-400 transition-colors duration-200 text-left pl-3">Отзывы о нас</button>
                <a href="https://dzen.ru/complexprint" target="_blank" rel="noopener noreferrer" className="block text-gray-300 hover:text-pink-400 transition-colors duration-200 text-left pl-3">Наш блог на Дзен</a>
              </div>
              
              {/* Группа "Справочники" */}
              <div className="pt-2">
                <div className="text-sm font-medium text-gray-400 mb-1">Справочники</div>
                <button onClick={() => go('/ceny')} className="block text-gray-300 hover:text-pink-400 transition-colors duration-200 text-left pl-3">Цены</button>
              ...
              <button onClick={() => go('/contacts')} className="block text-gray-300 hover:text-pink-400 transition-colors duration-200 text-left">Контакты</button>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8">
          <div className="flex flex-col items-start">
            <p className="text-gray-400 text-sm mb-4">© 2025 {companyInfo.name}. Все права защищены.</p>
            <div className="flex flex-col sm:flex-row sm:flex-wrap gap-2 sm:gap-x-4 sm:gap-y-2">
              <button onClick={() => go('/contacts')} className="text-gray-400 text-sm hover:text-pink-400 transition-colors duration-200 text-left">Контакты</button>
              <span className="text-gray-400 text-sm text-left">Политика конфиденциальности</span>
              <a href="/terms-of-service" className="text-gray-400 text-sm hover:text-pink-400 transition-colors duration-200 text-left">Условия обслуживания</a>
              <button onClick={() => setIsDetailsModalOpen(true)} className="text-gray-400 text-sm hover:text-pink-400 transition-colors duration-200 text-left">Реквизиты компании</button>
            </div>
          </div>
        </div>
      </div>
